...
public class MonitoryAmountUserType implements UserType, ParameterizedType{
	...
	public void setParameterValues(Properties parameters) {
		m_toCurrency = Currency.getInstance(parameters.getProperty("convertTo"));
	...
	public void nullSafeSet(PreparedStatement st, Object value, int index)
		...
		amount = amount.convertTo(m_toCurrency.getCurrencyCode());
